...
// null keys
        ...
        System.out.println(hash);        System.out.println(linked);   System.out.println(tree);
         // the tree can not take null values
        //
        hash.put("coffee", null);     linked.put("coffee", null);     tree.put("coffee", null);
        System.out.println(hash);  System.out.println(linked);        System.out.println(tree);// now null is working
        System.out.println("================================");
        // we can do the multiple value
